...
if ( !function_exists( 'pure_banner_shortcode' ) ) {
   function pure_banner_shortcode( $attrs, $content = null ) {
      ...
      if ( $enable_mask ) array_push( $banner_classes, esc_attr('with_mask') );

      if ( $enable_mask && $enable_mask_animation ) 
         array_push( $banner_classes, esc_attr('mask_animate') );

      if ( $enable_bg_scale ) array_push( $banner_classes, esc_attr('bg_scale') );
                  ...
                  <?php if ( $enable_button ): ?>
                     ...
                     <?php
                        ...
                        if ( $button_color || $button_bg_color ) {
                           ...
                           if ( $button_color ) $button_styling .= 'color:' . esc_attr( $button_color ) . ';';

                           if ( $button_bg_color ) $button_styling .= 'background-color:' . esc_attr( $button_bg_color ) . ';';
