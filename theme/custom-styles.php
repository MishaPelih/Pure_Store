...
<?php echo pure_js2tring( $pure_selectors['bg_color']); ?>{ background-color: <?php echo $active_color; ?>; }
<?php echo pure_js2tring( $pure_selectors['border_color']); ?>{ border-color: <?php echo $active_color; ?>; }
</style>
<?php
}
}